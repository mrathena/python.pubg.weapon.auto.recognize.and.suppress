...
# 载入对比图片
imgs1 = Game.Image.load(r'image/3440.1440/weapon.attachment/sight/1', gray=True, binary=True)
imgs2 = Game.Image.load(r'image/3440.1440/weapon.attachment/sight/2', gray=True, binary=True)
